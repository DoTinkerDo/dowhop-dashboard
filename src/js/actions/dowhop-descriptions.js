  ...
  doWhopDescriptionsRef
    ...
    .then(snapshot => {
      snapshot.forEach(childSnapshot => {
        ...
        // Delete desc without pushkey value
        // These are reviews only desc
...
const startListeningForDoWhopDescription = () => (dispatch: Function) => {
...
export default startListeningForDoWhopDescription;
